...
class DatabaseService {
  ...
  setCachedResult(key, data) {
    ...
    if (QUERY_CACHE.size > config.cache.maxSize) {
      ...
      entries.slice(0, 100).forEach(([key2]) => QUERY_CACHE.delete(key2));
    }
  }
  /**
...
//# sourceMappingURL=databaseService.mjs.map
