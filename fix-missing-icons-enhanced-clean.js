...
class EnhancedIconFixer {
  ...
  /**
   * Get special case images for items that need hardcoded image URLs
   */
  async getSpecialCaseImages(item) {
    ...
    // ??? mixture (hot, warm, horrible) - Use direct filenames, not URL encoded
    if (item.id === 5589) {
      return ["Question_mark_mixture_(hot).png"]
    }
    if (item.id === 5590) {
      return ["Question_mark_mixture_(warm).png"]
    }
    if (item.id === 5591) {
      return ["Question_mark_mixture_(horrible).png"]
    }

    // Cat items (Kittens, Cats, Overgrown cats)
    const catMapping = {
      1555: "Kitten_%28grey_and_black%29.png",
      1556: "Kitten_%28white%29.png", 
      1557: "Kitten_%28brown%29.png",
      1558: "Kitten_%28black%29.png",
      1559: "Kitten_%28grey_and_brown%29.png",
      1560: "Kitten_%28grey_and_blue%29.png",
      1561: "Cat_%28grey_and_black%29.png",
      1562: "Cat_%28white%29.png",
      1563: "Cat_%28brown%29.png", 
      1564: "Cat_%28black%29.png",
      1565: "Cat_%28grey_and_brown%29.png",
      1566: "Cat_%28grey_and_blue%29.png",
      1567: "Overgrown_cat_%28grey_and_black%29.png",
      1568: "Overgrown_cat_%28white%29.png",
      1569: "Overgrown_cat_%28brown%29.png",
      1570: "Overgrown_cat_%28black%29.png",
      1571: "Overgrown_cat_%28grey_and_brown%29.png",
      1572: "Overgrown_cat_%28grey_and_blue%29.png"
    }

    if (catMapping[item.id]) {
      return [catMapping[item.id]]
    }

    // Magic carpet animation item
    if (item.id === 5614) {
      return ["Magic_carpet.png"]
    }

    // Rune heraldic helm (Dragon)
    if (item.id === 8470) {
      return ["Rune_heraldic_helm_%28Dragon%29.png"]
    }
  ...
  async getWikiImageNames(item) {
    try {
      ...
      // Special handling for items with hardcoded image URLs
      const hardcoded = await this.getSpecialCaseImages(item)
      if (hardcoded && hardcoded.length > 0) {
        console.log(`    🎯 Found hardcoded image: ${hardcoded[0]}`)
        return hardcoded
      }
